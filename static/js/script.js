function showInfo(infoType) {
    ...
    switch (infoType) {
        case 'home':
            infoBox.innerHTML = `
                ...
                <section>
                    ...
                    <ul>
                        <li>Click the big <strong>Start Samples</strong> button at the bottom-right corner.</li>
                        <li>You will go to the samples page where you can begin using the tools.</li>
                    </ul>
                </section>
        ...
        default:
            infoBox.innerHTML = `<h2>Info</h2><p>No information available.</p>`;
    }
}
